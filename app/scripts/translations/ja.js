...
EOS_06                          :  'Ether/トークンの送出ページに移動', /*Go to Send Aura & Tokens Page*/
...
/* Onboarding */
ONBOARD_welcome_title           :  'いらっしゃいませ！ Aura Wallet へようこそ！', /*Welcome to Aura Wallet*/
...
ONBOARD_welcome_content__5      :  'MyEtherWalletはソースコード公開で、クライアント側にある無料で共用の利用者窓口です。', /*Aura Wallet is based on MyEtherWallet , a free, open-source, client-side interface.*/
...
ONBOARD_interface_content__1    :  'MyEtherWalletを使って口座を作る時、一対の暗号のための二つの長い数字、すなわち秘密鍵と公開鍵（アドレス）とが作成されます。', /*When you create an account on Aura Wallet you are generating a cryptographic set of numbers: your private key and your public key (address).*/
...
ONBOARD_blockchain_content__5   :  'MyEtherWalletや[explore.auraledger.com](https://explore.auraledger.com)で残高や処理を見た時、見えるのは私たちのシステムの中ではなく、ブロックチェーンにあるデータです。', /*When you see your balance on Aura Wallet or view your transactions on [explore.auraledger.com](https://explore.auraledger.com), you are seeing data on the blockchain, not in our personal systems.*/
...
ONBOARD_secure_1_content__3     :  'いつも、必ず、ＵＲＬ：「https://www.myetherwallet.com」を確認してください。', /*Always check the URL: `https://wallet.auraledger.com`.*/
...
PARITY_AlreadyImported      : "(parity-01) 同じハッシュのトランザクションがすでにインポートされています。 A transaction with the same hash was already imported. It was probably already broadcast. To avoid duplicate transactions, check your address on [explore.auraledger.com](https://explore.auraledger.com) & wait 10 minutes before attempting to send again. [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
...
NODE_Warning                : 'Aura Wallet 経由で接続するためには、HTTPSノードが必要です。[MyEtherWalletをレポジトリからダウンロードして、手元で走らせ、](https://github.com/kvhnuke/etherwallet/releases/latest)いずれかのノードに接続することもできます。 あるいは、無料のSSL証明書を[LetsEncrypt](https://letsencrypt.org/)から入手してください',
NODE_Name                   : 'ノード名',
NODE_Port                   : 'ノードポート',
...
TranslatorAddr_4            : '',
TranslatorAddr_5            : '',
TranslatorName_1            : '[sekisanchi.eth](https://explore.auraledger.com/#/address/0xf991119eea62eee1a6fdaa7f621e91a42f325fce) ', /* Translator 1: Kazunori Seki / 関一典 */
...
VIEWWALLET_Subtitle         : '異なったバージョンの秘密鍵をダウンロードしたり、お財布紙情報を再印刷することができます。[import your account into Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/)する時に必要です。残高をチェックするためには、[explore.auraledger.com](https://explore.auraledger.com/)のようなブロックチェーンエクスプローラーサービスを使う事をおすすめします。 ',
...
HELP_3_Desc_3               : 'Navigate to the Aura Wallet "View Wallet Info" page. ',
...
HELP_5_Title                : '5) How do I run Aura Wallet offline/locally? ',
HELP_5_Desc_1               : 'You can run Aura Wallet on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page. ',
HELP_5_Desc_7               : 'Aura Wallet is now running entirely on your computer. ',
...
HELP_5_Desc_9               : 'As we are constantly updating Aura Wallet, we recommend you periodically update your saved version of the repo. ',
...
HELP_8_Desc_2               : 'If Aura Wallet goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Ether out of MyEtherWallet because it\'s not in MyEtherWallet. It\'s in whatever wallet your generated via our site. ',
...
HELP_14_Title               : '14) Some sites randomize (seed) the private key generation via mouse movements. Aura Wallet doesn\'t do this. Is the random number generation for MyEtherWallet safe? ',
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, Aura Wallet can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_Remind_Desc_1          : '**Ethereum, Aura Wallet & MyEtherWallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Ether**. ',
HELP_Remind_Desc_2          : 'Aura Wallet & MyEtherWallet CX are not "web wallets". You do not create an account or give us your Ether to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain. ',
...
HELP_SecCX_Desc_6           : 'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use Aura Wallet instead of this Chrome Extension. ',
