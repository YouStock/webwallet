...
NAV_SendEther               : 'Send Aura & Tokens ',
...
HELP_1_Desc_1               : 'Gå til "Send Aura & Tokens"-siden. ',
...
HELP_3_Desc_3               : 'Naviger til Aura Wallet sin "Vis lommebok-info"-side. ',
...
HELP_4_Desc_2               : 'Naviger til "Send Aura & Tokens"-siden. ',
...
HELP_4CX_Desc_1             : 'Først må du legge til en lommebok. Når du har gjort det, har du 2 muligheter: den kjappe "Send"-funksjonaliteten fra Chrome-utvidelsesikonet eller "Send Aura & Tokens"-siden. ',
...
HELP_4CX_Desc_12            : 'Bruk "Send Aura & Tokens"-siden ',

HELP_5_Title                : '5) Hvordan kan jeg bruke Aura Wallet offline/lokalt? ',
HELP_5_Desc_1               : 'Du kan bruke Aura Wallet på datamaskinen din i stedet for fra GitHub-serverne. Du kan opprette en lommebok fullstendig frakoblet fra internett, og sende transaksjoner fra "Send offline"-siden. ',
HELP_5_Desc_7               : 'Aura Wallet kjører nå utelukkende på din datamaskin. ',
...
HELP_5_Desc_9               : 'Siden vi oppdaterer Aura Wallet hele tiden, anbefaler vi at du oppdaterer din lagrede versjon av repoet jevnlig. ',
...
HELP_7_Desc_1               : 'Naviger til "Send Aura & Tokens"-siden. ',
...
HELP_8_Desc_2               : 'Hvis Aura Wallet går ned, må du finne en annen måte (som f.eks. geth eller Ethereum Wallet / Mist) å gjøre det på. Men du vil ikke trenge å "hente" eteren din ut av MyEtherWallet, fordi den ikke befinner seg i MyEtherWallet. Den befinner seg i den lommeboka/kontoen som du opprettet ved hjelp av nettsiden vår. ',
...
HELP_9_Title                : '9) Er "Send Aura & Tokens"-siden offline? ',
...
HELP_10_Desc_11             : 'Lim inn den signerte transaksjonen i tekstfeltet i steg #3 på den tilkoblede maskinen og klikk "Send Aura & Tokens". Dette vil kringkaste transaksjonen din. ',
...
HELP_16_Desc_1              : 'Du kan bruke en blokkjede-utforsker som [explore.auraledger.com](https://explore.auraledger.com/). Lim inn adressen i søkefeltet og den vil finne fram adressen og transaksjonshistorikken. For eksempel, her ser du hvordan vår [donasjonskonto](https://explore.auraledger.com/#/address/0x7cb57b5a97eabe94205c07890be4c1ad31e486a8) ser ut på explore.auraledger.com ',

HELP_17_Title               : '17) Hvorfor vises ikke saldoen min når jeg låser opp lommeboken min? ',
HELP_17_Desc_1              : 'Dette er mest sannsynlig fordi du er bak en brannmur. API-en vi bruker for å innhente saldoen blokkeres ofte av brannmurer av ymse årsaker. Du vil fortsatt være i stand til å sende transaksjoner, du må bare bruke en annen metode for å se nevnte saldo, som explore.auraledger.com ',
...
HELP_SecCX_Desc_6           : 'Hvis vi skulle kryptere disse, måtte du ha oppgitt et passord hver gang du ønsket å se saldo for kontoene dine eller vise kallenavnene. Hvis dette bekymrer deg, anbefaler vi deg å bruke Aura Wallet i stedet for denne Chrome-utvidelsen. ',
...
HELP_Sec_Desc_3             : 'Vi kommer ikke til å ta pengene dine eller stjele dine private nøkler. Det er ingen ondsinnet kode på denne siden. Faktisk er "Send Aura & Tokens"-siden fullstendig klient-drevet. Det betyr at all koden blir kjørt på ** din datamaskin ** og det blir aldri lagret eller overført noe sted. ',
