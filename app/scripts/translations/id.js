...
EOS_06                          :  'Buka halaman Send Aura & Tokens',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Selamat datang di Aura Wallet',
...
ONBOARD_blockchain_content__5   :  'Saat Anda melihat saldo di Aura Wallet atau melihat transaksi Anda di [explore.auraledger.com](https://explore.auraledger.com), Anda melihat data di blockchain, bukan di sistem privat Anda.',
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Memungkinkan Anda untuk mencetak Dompet Kertas dari berbagai format atau versi Kunci Privat. Hal ini diperlukan pada saat anda ingin [mengimpor akun Anda ke Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Jika Anda hanya ingin pengecekan saldo, pakailah salah satu layanan blockchain explorer seperti [explore.auraledger.com](https://explore.auraledger.com/). ',
...
NODE_Warning                : 'Node Anda harus berupa HTTPS untuk dapat terhubung melalui Aura Wallet. Anda dapat [mengunduh MyEtherWallet repo & menjalankannya secara lokal](https://github.com/kvhnuke/etherwallet/releases/latest) untuk terhubung ke node apa saja. Atau, dapatkan SSL certificate gratis melalui [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Nama Node',
NODE_Port                   : 'Port Node',
...
HELP_3_Desc_3               : 'Buka laman Aura Wallet bagian "Lihat Info Dompet" . ',
...
HELP_5_Title                : '5) Bagaimana cara menjalankan Aura Wallet secara offline/lokal? ',
HELP_5_Desc_1               : 'Anda dapat menjalankan Aura Wallet secara lokal di komputer Anda, bukan dari server GitHub. Anda dapat membuat dompet yang benar-benar offline dan mengirim transaksi dari laman "Transaksi Offline". ',
HELP_5_Desc_7               : 'Aura Wallet sekarang berjalan sepenuhnya di komputer Anda. ',
...
HELP_5_Desc_9               : 'Karena kami masih terus memperbarui Aura Wallet, sebaiknya Anda juga memperbarui versi repo yang Anda simpan secara berkala. ',
...
HELP_8_Desc_2               : 'Jika situs Aura Wallet tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" Ether Anda dari Aura Wallet karena Ether Anda tidak disimpan di Aura Wallet. Ether Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_16_Desc_1              : 'Anda bisa menggunakan eksplorer blockchain seperti [explore.auraledger.com](https://explore.auraledger.com/). Paste alamat Anda ke dalam search bar dan riwayat transaksi Anda akan ditampilkan. Contohnya, [akun donasi kami](https://explore.auraledger.com/#/address/0x7cb57b5a97eabe94205c07890be4c1ad31e486a8) dilihat di explore.auraledger.com ',

HELP_17_Title               : '17) Mengapa saldo saya tidak muncul saat saya membuka dompet saya? ',
HELP_17_Desc_1              : 'Hal ini kemungkinan besar karena Anda berada di belakang firewall. API yang kami gunakan untuk mendapatkan saldo dan mengonversi saldo tersebut terkadang diblokir oleh firewall. Anda masih bisa mengirim transaksi, Anda hanya perlu menggunakan metode yang berbeda untuk melihat saldo tersebut, misalnya memakai explore.auraledger.com ',
...
HELP_SecCX_Desc_6           : 'Jika kami mengenkripsi item ini, Anda harus memasukkan password setiap kali Anda ingin melihat saldo akun atau melihat nickname. Jiak Anda khawatir, kami sarankan Anda menggunakan Aura Wallet, bukan Chrome Extension ini. ',
