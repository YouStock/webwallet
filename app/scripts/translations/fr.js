...
HELP_3_Desc_3               : 'Naviguez vers la page Visualisation d\'un portefeuille" de Aura Wallet.',
...
HELP_5_Title                : '5) Comment puis-je lancer Aura Wallet hors ligne (en local) ?',
HELP_5_Desc_1               : 'Vous pouvez lancer Aura Wallet sur votre ordinateur au lieu de passer par les serveurs GitHub. Vous pouvez générer un portefeuille en restant totalement hors ligne et envoyer des transactions depuis la page "Transaction hors ligne".',
HELP_5_Desc_7               : 'Aura Wallet tourne maintenant complètement sur votre ordinateur.',
...
HELP_5_Desc_9               : 'Comme nous améliorons constamment Aura Wallet, nous vous recommandons de mettre régulièrement à jour votre version de sauvegarde.',
...
HELP_SecCX_Desc_6           : 'Si nous devions chiffrer ces informations, il vous faudrait entrer un mot de passe à chaque fois que vous voudriez voir votre solde ou les surnoms. Si cela vous ennuie, nous vous recommandons d\'utiliser Aura Wallet au lieu de cette extension Chrome.',
