...
NODE_Warning                : 'Your node must be HTTPS in order to connect to it via Aura Wallet. You can [download the MyEtherWallet repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Name',
NODE_Port                   : 'Node Port',
...
VIEWWALLET_Subtitle         : 'Ceci vous permet de télécharger plusieurs versions des clefs privées et de ré-imprimer votre portefeuille papier. Vous devrez le faire pour [importer votre compte dans Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si vous voulez consulter votre solde, nous recommandons d\'utiliser un explorateur de blockchain comme [explore.auraledger.com](https://explore.auraledger.com/). ',
...
HELP_4_Desc_2               : 'Navigate to the "Send Aura & Tokens" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send Aura & Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Send Aura & Tokens" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Send Aura & Tokens" page. ',
...
HELP_9_Title                : '9) Is the "Send Aura & Tokens" page offline? ',
