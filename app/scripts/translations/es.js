...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Esto te permite descargar múltiples versiones de claves privadas e imprimir de nuevo tu cartera en papel. Puede que te interese hacer esto para [importar tu cuenta en Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si quieres comprobar tu saldo, recomendamos utilizar un explorador de blockchain como [explore.auraledger.com](https://explore.auraledger.com/). ',
...
HELP_3_Desc_3               : 'Ve a la página "Ver Información de las Carteras" de Aura Wallet. ',
...
HELP_5_Title                : '5) ¿Cómo ejecuto Aura Wallet sin conexión/localmente? ',
HELP_5_Desc_1               : 'Puedes ejecutar Aura Wallet en tu equipo en lugar de desde los servidores de GitHub. Puedes generar una cartera totalmente sin conexión y enviar transacciones desde la página "Transacción sin conexión". ',
...
HELP_5_Desc_9               : 'Debido a que estamos constantemente actualizando Aura Wallet, recomendamos que actualices periódicamente tu versión guardada del repositorio. ',
...
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experments) believe in window.crypto. In addition, Aura Wallet can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_16_Desc_1              : 'You can use a blockchain explorer like [explore.auraledger.com](https://explore.auraledger.com/). Paste your address into the search bar and it will pull up your account and transaction history. For example, here\'s what our [donation account](https://explore.auraledger.com/#/address/0x7cb57b5a97eabe94205c07890be4c1ad31e486a8) looks like on explore.auraledger.com ',
...
HELP_SecCX_Desc_6           : 'Si cifráramos estos ítems, sería necesario que introduzcas una contraseña cada vez que quisieras comprobar el saldo de tu cuenta o vizualizar los alias. Si esto te preocupa, te recomendamos que utilices Aura Wallet en lugar de esta extensión de Chrome. ',
