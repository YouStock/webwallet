            ...
            <div class="col-xs-12 col-sm-7 onboarding__content">
              ...
              <ul>
                <li translate="ONBOARD_welcome_content__5">
                  Aura Wallet is based on MyEtherWallet , a free, open-source, client-side interface.
                </li>
            ...
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_blockchain_content__5">
                  When you see your balance on Aura Wallet or view your transactions on [explore.auraledger.com](https://explore.auraledger.com), you are seeing data on the blockchain, not in our personal systems.
                </li>
