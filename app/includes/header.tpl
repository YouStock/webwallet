...
<meta name="description" content="MyEtherWallet (MEW) is a free, open-source, client-side interface for generating Aura wallets & more. Interact with the Aura blockchain easily & securely.">
<meta property="og:description"  content="Free, open-source, client-side Aura wallet. Enabling you to interact with the blockchain easily & securely.">
<meta name="twitter:description" content="Free, open-source, client-side Aura wallet. Enabling you to interact with the blockchain easily & securely.">
...
<meta name="apple-mobile-web-app-title" content="MyEtherWallet &middot; Your Key to Aura">
...
"sameAs" : [
  ...
  "https://twitter.com/YoustockProject",
  "https://medium.com/youstock",
...
@@if (site === 'mew' ) {
  <!--div class="small announcement annoucement-danger">
    <div class="container">
      ...
      <br />
      1. BOOKMARK <a href="https://wallet.auraledger.com"> WALLET.AURALEDGER.COM </a>
